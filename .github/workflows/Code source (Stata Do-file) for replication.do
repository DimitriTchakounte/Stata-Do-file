    **** Paper title : The effect of women's bargaining pOower within couple on contraceptive use in Cameroon****
...
*I) Removing couples withn which women were pregnant at the time of the survey
		 drop if v213==1 
...
*III)   The independent variables
     *1) Variable of interest : Women's Bargaining power. There are 6 dimensions:
	  ...
	  *a) Dimension of Women's role in decision making	
		  ...
		  * NB: decision on contraceptive use have been removed because it contains to much missing values (85%).
	  ...
	  *e) Dimension of Women membership to committee association
     ...
     *2) Control variables 	 
	  ...
	  *d) Intermediary factors of contraception 
	    ...
	    * Husband approve family planning
       ...
       *e) Exposure of women to medias: television and radio
 ...
 * IV) Descriptive Statistics : univariate and bivariate (Cross tabulation) statistics
...
* V) Econometric estimation
   ...
   *2) Robustness checks : Probit model with sample selection 
    ...
    gen ideal=v613 // ideal size of family reported by women
	egen mean_ideal=mean(ideal) if ideal<96
	tab mean_ideal
    replace ideal=6 if ideal==96
	/* NB: Before run the heckman probit model, the dependant (contraceptive use) and 
	independant varaibles (WBPCI and control variables) should be generated*/ 
